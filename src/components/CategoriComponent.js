...
export const CategoriComponent = () => {
  return (
    ...
    }} className="w-3/4 text-xl font-DMSans  h-20 mx-auto p-5 px-5 justify-between items-center flex flex-row bg-slate-700 border-1 mt-5 ">
      <div className="flex flex-row pl-7 gap-5">
        <div>
          <h1>Categories</h1>
        </div>
        <div>
